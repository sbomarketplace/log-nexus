...
export const PolicyModal = ({ open, onOpenChange, type }: PolicyModalProps) => {
  if (!open) return null;
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50">
      <div className="fixed inset-0 z-50 grid place-items-center p-4">
        <div className="w-full max-w-3xl max-h-[85vh] bg-background rounded-2xl shadow-2xl transform transition-all">
          {/* Sticky Header */}
